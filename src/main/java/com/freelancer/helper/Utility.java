...
public class Utility 
{
	...
	public static WebElement getElement(WebDriver driver, By locator) {
		...
		try{
			...
			System.out.println("Unable to normal click: "+ e.getMessage());

		}


		if(ConfigFileReader.getProperty("highlightElement").equalsIgnoreCase("true"))
		{
	...
	public static int GetAllElements(WebDriver driver,By locator,String attr) {
		 List<WebElement> ele= driver.findElements(locator);
		 int totaltinks=ele.size();
		 
		 for( WebElement element: ele) {
			 
			String elements= element.getAttribute(attr);
			System.out.println("Elemenet name--"+elements);
		 }
